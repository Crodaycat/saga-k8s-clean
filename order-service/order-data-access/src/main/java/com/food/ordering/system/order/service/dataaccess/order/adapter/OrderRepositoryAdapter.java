...
public class OrderRepositoryAdapter implements OrderRepository {
    ...
    public OrderRepositoryAdapter(OrderJpaRepository orderJpaRepository, OrderDataAccessMapper orderDataAccessMapper) {
    ...
    public Order save(Order order) {
        return orderDataAccessMapper.orderEntityToOrder(
                this.orderJpaRepository.save(orderDataAccessMapper.orderToOrderEntity(order))
        );
    }
