...
public class OderApplicationServiceTest {
    @Autowired
    ...
    public void testCreateOrderWithWrongProductPrice() {
        ...
        assertEquals(
                "Order item price: 60.0 is not valid for product " + PRODUCT_ID,
                orderDomainException.getMessage()
        );
    }
