...
@Configuration
public class KafkaConsumerConfig<Key extends Serializable, Value extends SpecificRecordBase> {
    ...
    @Bean
    public ConsumerFactory<Key, Value> consumerFactory() {
        return new DefaultKafkaConsumerFactory<>(consumerConfig());
    }

    @Bean
    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<Key, Value>> kafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<Key, Value> factory = new ConcurrentKafkaListenerContainerFactory<>();
